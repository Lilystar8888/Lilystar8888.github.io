...
<body>
    ...
    <div id="wrap">
        <div class="kv-purification">
            <h1 class="title-steps misc">step.1<div>淨化</div></h1>
            <h2 class="subtitle-steps">協助身體排出<br>老舊廢物和毒素</h2>
            <p class="detail-steps">營養減重的第一步就是幫身體排毒！利用淨化期，排除身體累積<br>已久的廢物，不只身體會感覺到輕盈，也讓你覺得很有成就感！</p>
            <div class="kv-tag"><span>乳酸菌</span><span class="tagpd">維生素<br>B群</span><span>纖維</span></div>
