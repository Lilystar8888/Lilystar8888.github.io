...
$$('simplePagination ', function () {
    ...
    function bindPagination(qty) {
        $(selector).pagination({
            ...
            onPageClick: function (pageNumber) { getSuccessfulCase(pageNumber); $('body,html').animate({ scrollTop: 0 }, 'slow'); },
    ...
    $(document).on("keypress", '.searchbar input[type=text]', function (e) {
    //$('.searchbar input[type=text]').bind("keypress", function (e) {
