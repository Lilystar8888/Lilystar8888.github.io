<%@ Page Language="C#" AutoEventWireup="true" CodeFile="exam-result.aspx.cs" Inherits="app_exam_result" %>
<script runat="server">
...
<body>
    ...
    <div id="wrap">
        ...
        <div class="exam">
            <h2 class="title-exam">
                你的類型屬於…</h2>
            <div class="result01" id="result01" runat="server">
                <div class="kv-result none">
                    健康樂活型</div>
                ...
                <ol class="num txtgreen textb">
                    ...
                    <li>綜合維生素/礦物質/植物營養素<p>
                        維持生理機能正常運作。</p>
                    </li>
                    <li>優質蛋白質<p>
                        植物性蛋白質比動物性更容易為人體消化利用。</p>
                    </li>
                    <li>綠茶磷脂複合物<p>
                        有助減少腰圍，輕鬆做好體重管理。</p>
                    </li>
            ...
            <div class="result02" id="result02" runat="server">
                <div class="kv-result none">
                    壓力多吃型</div>
                <h3 class="title-green">
                    減重成功的關鍵</h3>
            ...
            <div class="result03" id="result03" runat="server">
                <div class="kv-result none">
                    暴飲暴食型</div>
                <h3 class="title-green">
                    減重成功的關鍵</h3>
                ...
                <ol class="num txtgreen">
                    <li>營養代餐<p>
                        每天可選擇1至2餐改用營養代餐，降低一天總熱量的吸收。</p>
                    </li>
                    <li>膳食纖維+充足水分<p>
                        增加飽足感，有效降低食物熱量吸收。</p>
                    </li>
                    <li>魚油<p>
                        Omega-3 脂肪酸可幫助降低食慾。</p>
                    </li>
                    <li>腰豆、黃豆萃取菁華的補充品<p>
                        抑制澱粉和蔗糖吸收。</p>
                    </li>
            ...
            <div class="result04" id="result04" runat="server">
                <div class="kv-result none">
                    糖心型</div>
                <h3 class="title-green">
                    減重成功的關鍵</h3>
            ...
            <div class="result05" id="result05" runat="server">
                <div class="kv-result none">
                    代謝偏低型</div>
                <h3 class="title-green">
                    減重成功的關鍵</h3>
        ...
        <div class="exam-entry">
            <ul class="writings-list">
                ...
                <li>
                    <div class="pic">
                        <a href="detail.aspx?no=<%=liThisArticleInfo[i].articleInfo.UNO %>">
                            <img src="../API/GetPic.ashx?Token=<%:GetToken() %>&Type=Article&FileName=<%=liThisArticleInfo[i].articleInfo.LargePicName%>" height="639" width="960" alt="" /></a></div>
                    <div class="writings-detail">
                        <a href="detail.aspx?no=<%=liThisArticleInfo[i].articleInfo.UNO %>"><%=liThisArticleInfo[i].articleInfo.Title %></a></div>
                    <div class="tag-area">
                        <!--五型-->
                        <%for(int j=0;j<liThisArticleInfo[i].liBodyTypeInfo.Count;j++) {%>
                        <a href="tag-related.aspx?type=bodytype&p=<%=liThisArticleInfo[i].liBodyTypeInfo[j].UNO %>" class="btn-kind"  data-tracking="ga('send','event','mobile','label.type','<%=liThisArticleInfo[i].liBodyTypeInfo[j].Name%>');"><%=liThisArticleInfo[i].liBodyTypeInfo[j].Name%></a> 
                        <%} %>
                    </div>
                    <div class="tag-area">
                        <!--營養素-->
                        <%for(int j=0;j<liThisArticleInfo[i].liNutrientInfo.Count;j++) {%>
                        <a href="tag-related.aspx?type=nutrient&p=<%=liThisArticleInfo[i].liNutrientInfo[j].UNO %>" class="btn-nutriment"  data-tracking="ga('send','event','mobile','label.nutrient','<%=liThisArticleInfo[i].liNutrientInfo[j].Name%>');"><%=liThisArticleInfo[i].liNutrientInfo[j].Name%></a>
                        <%} %>
                    </div>
                </li>
                <%} %>
        ...
        <div class="liaison">
            <h4>
                進一步了解你的身體組成...</h4>
            <p>
                歡迎連絡直銷商，一同前往<span class="txt-orange txt-strong">
    ...
    <script src="<%:Url.Resolve("~/js/lib/requirejs/require-2.1.20.min.js")%>" data-main="<%:MainJs%>"
