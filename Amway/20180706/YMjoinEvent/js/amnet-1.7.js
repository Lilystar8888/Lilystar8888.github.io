/*
    AMNET Tracking JavaScript V1.6
    ...
    Page Tracking:
        ...
        各提供商參數順序:
            ...
            amnet('yahoo'       , 'page', projectId, pixelId);
    ...
    Event Tracking:
        ...
        各提供商參數順序:
            ...
            amnet('yahoo'       , 'event', projectId, pixelId, et, ea);
*/
...
(function (window) {
    ...
    pixels['clickforce'] = new (function () {
        this.page = function (mid) {
            ...
            appendScriptToBody('//static.doublemax.net/site/mlt.js');
        }

        this.event = function (action) {
            window['MLTracker'].track({ type: 'event', action: action });
        }
    })();
    //#endregion
    ...
    pixels['yahoo'] = new (function () {
        ...
        this.page = function (projectId, pixelId) {
            _init();
            setTimeout(function () {
        ...
        this.event = function (projectId, pixelId, et, ea) {
            _init();
            setTimeout(function () {
                window['YAHOO'] && window['YAHOO'].ywa.I13N.fireBeacon([{
                    "projectId": projectId,
