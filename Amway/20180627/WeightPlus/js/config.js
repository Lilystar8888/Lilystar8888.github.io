...
(function() {
	...
	// JS 模組設定
	require.paths = {
		'jquery': Min('//ajax.googleapis.com/ajax/libs/jquery/' + (old ? '1.11.3' : '2.1.4') + '/jquery')
		...
		, 'fb': JSLibPathMin('facebook/jquery.fb-1.0.11') // facebook 基本控制
		...
		, 'mtagconfig': 'https://az623152.vo.msecnd.net/library/javascript/support/cn/mtagconfig'
        , 'simplePagination': JSLibPathMin('jquery/jquery.simplePagination') // 分頁
	};
