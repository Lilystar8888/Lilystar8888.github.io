<%@ Page Language="C#" %>
<% var CategoryTags = GetCategoryTags("4");  %>
<script runat="server">
    protected override void Render(HtmlTextWriter writer)
    {
		META_TITLE="減重四大計畫-美型";
        META_DESCRIPTION = @"美型期重點在於利用營養素，提升體內肌肉量，也幫助減重後的身材提昇緊實感，雕塑完美曲線。";
        META_IMAGE = "~/images/fb_in-shape.jpg";
	    base.Render(writer);
	}
</script>
...
<body>
    ...
    <div id="wrap">
        <div class="kv-in-shape">
            <h1 class="title-steps misc">step.4<div>美型</div></h1>
            <h2 class="subtitle-steps">提升肌肉量<br>雕塑完美曲線</h2>
            <p class="detail-steps">美型期重點在於利用營養素，提升體內肌肉量，<br>也幫助減重後的身材提昇緊實感，雕塑完美曲線。</p>
            <div class="kv-tag"><span class="tagpd">共軛亞<br>麻油酸</span><span class="tagpd">優質<br>蛋白質</span><span class="tagpd">維生素<br>C</span></div>
        ...
        <div class="content">
            <% foreach (var TagInfo in CategoryTags){ %>
                ...
                <ul class="focus-writing">
                    <%var obj = GetTagArticle("4", TagInfo.UNO.ToString()); %>
