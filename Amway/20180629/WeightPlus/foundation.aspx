...
<body>
    ...
    <div id="wrap">
        <div class="kv-foundation">
            <h1 class="title-steps misc">step.2<div>打底</div></h1>
            <h2 class="subtitle-steps">均衡營養<br>調整成為易瘦體質</h2>
            <p class="detail-steps">老舊廢物淨化排除後，想順利恢復身體機能，<br>迅速燃燒身體脂肪，就得要做好基礎打底的動作！</p>
            <div class="kv-tag"><span class="tagpd">均衡<br>代餐</span><span class="tagpd">優質<br>蛋白質</span><span class="tagpd">綜合<br>營養素</span><span>魚油</span></div>
