...
$$('simplePagination ', function () {
    ...
    function BindData(rowCount) {
        ...
        for (var i = 0; i < rowCount; i++) {
            ...
            var tempNutrient = "", tempBodyType = "", display = oData.IsHot ? "block" : "none";
            ...
            str += '<li><div class="pic box-inline"><a href="detail.aspx?no=' + oData.UNO + '"><img src="API/GetPic.ashx?Token=' + Config.Token + '&Type=Article&FileName=' + oData.LargePicName + '" alt=""/></a></div>' +
                        '<div class="writings-detail box-inline"><div class="writings-new" style="display:' + display + '">NEW</div><h3><a href="detail.aspx?no=' + oData.UNO + '">' + oData.Title + '</a></h3>' +
    ...
    function getSuccessfulCase(pageNumber) {
        $.callAPI('API/GetFourStepArticle.ashx', {
            Token: "", Category: "1", PageIndex: pageNumber, PageSize: gPageSize
    ...
    function bindPagination(qty) {
        $(selector).pagination({
            ...
            onPageClick: function (pageNumber) { getSuccessfulCase(pageNumber); $('body,html').animate({ scrollTop: $(".title-page-left").offset().top }, 'slow'); },
