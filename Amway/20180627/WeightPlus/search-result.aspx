    ...
    <div id="wrap">
        <div class="content">
            <div class="search-area">
                <h1 class="search-title box-inline">搜尋結果</h1>
                <div class="searchbar box-inline">
                    <input type="text" class="box-inline" placeholder="" value="" required="">
                    <a href="javascript:;" class="search-btn box-inline">搜尋</a>
                </div>
            </div>
