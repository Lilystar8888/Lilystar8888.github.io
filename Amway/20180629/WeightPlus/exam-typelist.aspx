...
自然擁有完美體態。</p>
        ...
        <div class="content">
            ...
            <ul class="typelist">
                <li class="typelist04"><a href="exam-type.aspx?type=04">熱愛含糖飲料、甜點、零食，也可能會喝烈酒，糖類與脂肪攝取過多...</a></li>
                <li class="typelist05"><a href="exam-type.aspx?type=05">飲食節制、進食量少，卻可能有營養素不足、體脂肪超標的情況...</a></li>
                <li class="typelist02"><a href="exam-type.aspx?type=02">生活不規律，吃飯時間非早即晚，以「吃」解決壓力，尋求慰藉，導致體重節節攀升...</a></li>
		<li class="typelist03"><a href="exam-type.aspx?type=03">不管「自以為」吃的多不多，攝取的熱量都超標，但蔬果攝取量卻不足，易有營養不均的狀況...</a></li>
                <li class="typelist01"><a href="exam-type.aspx?type=01">飲食節制，或是工作關係會大量消耗熱量。注重健康，有運動習慣...</a></li>
            </ul>
        </div>
    </div>
