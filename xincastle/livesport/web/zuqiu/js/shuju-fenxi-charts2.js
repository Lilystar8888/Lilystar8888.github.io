$(function() {
    ...
    var d = function() {
        $("#columnsNav li").sort(function(a, f) {
            return $($(a).find("a").attr("href")).index() - $($(f).find("a").attr("href")).index()
        }).appendTo($("#columnsNav"));
    ...
    $("#columns").sortable({
        ...
        create: function(a, c) {
            ...
            $(".tool-box ul li").click(function() {
                var a = $(this).index();
                $(this).hasClass("disabled") && ($(this).removeClass("disabled"), $(".shuju-main-content .content-wrap").eq(a).show());
                d()
            })
        }
    });
    ...
    $(".saiguo-chart").attr("class", "saiguo-chart");
    $(".panlu-chart").attr("class", "saiguo-chart");
    $(".daxiao-chart").attr("class", "saiguo-chart");
    $(".danshuang-chart").attr("class", "saiguo-chart");
    $(".chartinfo").attr("class", "chartinfo");
    $(".recent-score").each(function() {
        var a = eval($(this).data("score")),
            c = function(a) {
                for (var b = [], e = 0; e < a.length; e++) {
                    var c = a[e][0][0] - a[e][0][1];
                    0 > c ? b.push(1) : 0 == c ? b.push(2) : 0 < c && b.push(3)
                }
                return b
            }(a),
            f = $(this).data("label");
        $(this).highcharts({
            ...
            yAxis: {
                ...
                labels: {
                    ...
                    formatter: function() {
                        ...
                        switch (this.value) {
                            case 1:
                                a = '<b style="color:#0180ff">\u8d1f</b>';
                                break;
                            case 2:
                                a = '<b style="color:#83cb00">\u5e73</b>';
                                break;
                            case 3:
                                a = '<b style="color:#de1e30">\u80dc</b>'
                        }
                        return a
                    }
                }
            ...
            tooltip: {
                ...
                pointFormatter: function() {
                    var b = a[this.index];
                    return '<p">' + b[1][0] + " vs " + b[1][1] + '</p><p style="text-align: center">' + b[0][0] + ":" + b[0][1] + "</p>"
                }
            },
            plotOptions: {
                area: {
    ...
    $(".odds-chart").each(function() {
        var a = eval($(this).data("odds")),
            c = null,
            f = null;
        ! function(a) {
            for (var b = [], e = [], d = 0; d < a.length; d++) {
                var g = a[d];
                0 > g ? (b.push(1), e.push("\u8f93\u76d8")) : 0 == g ? (b.push(2), e.push("\u8d70\u76d8")) : 0 < g && (b.push(3), e.push("\u8d62\u76d8"))
            }
            c = b;
            f = e
        }(a);
            ...
            yAxis: {
                ...
                labels: {
                    ...
                    formatter: function() {
                        ...
                        switch (this.value) {
                            case 1:
                                a = '<b style="color:#0180ff">\u8f93\u76d8</b>';
                                break;
                            case 2:
                                a = '<b style="color:#83cb00">\u8d70\u76d8</b>';
                                break;
                            case 3:
                                a = '<b style="color:#de1e30">\u8d62\u76d8</b>'
                        }
                        return a
                    }
                }
